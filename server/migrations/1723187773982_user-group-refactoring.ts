  ...
  pgm.sql(
    `
      ...
      ALTER TABLE DATA.survey
        ADD CONSTRAINT fk_background_image FOREIGN KEY (background_image_path, background_image_name, organization) REFERENCES data.files (file_path, file_name, organization) ON DELETE SET NULL,
        ADD CONSTRAINT fk_thanks_page_image FOREIGN KEY (thanks_page_image_path, thanks_page_image_name, organization) REFERENCES DATA.files(file_path, file_name, organization) ON DELETE SET NULL,
        ADD CONSTRAINT fk_top_margin_image FOREIGN KEY (top_margin_image_path, top_margin_image_name, organization) REFERENCES DATA.files(file_path, file_name, organization) ON DELETE SET NULL,
        ADD CONSTRAINT fk_bottom_margin_image FOREIGN KEY (bottom_margin_image_path, bottom_margin_image_name, organization) REFERENCES DATA.files(file_path, file_name, organization) ON DELETE SET NULL;
    `,
  );
}
